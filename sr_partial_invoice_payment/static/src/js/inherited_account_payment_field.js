odoo.define('sr_partial_invoice_payment.payment', function (require) {
"use strict";
    ...
    var ShowPaymentLineWidget = AbstractField.extend({
        ...
        _onOutstandingCreditAssign: function (event) {
            ...
            var move_type = $(event.target).data('move-type') || false;
            if (move_type == "out_invoice"){
                this.do_action({
                    ...
                    view_type: 'form',
                    views: [[false, 'form']],
                    res_id: $(event.target).data('resId'),
                    target: 'new',
                    context: {
                        line_id: id,
